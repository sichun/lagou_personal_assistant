...
#define column name
col_names = ["positionId", "positionName", "salary", "workYear", "education", "jobNature", "isSchoolJob",
             "positionAdvantage", "firstType", "secondType", "companyId", "companySize", "financeStage",
             "industryField", "companyShortName", "companyFullName", "city", "district", "longitude",
             "latitude", "formatCreateTime", "resumeProcessRate", "resumeProcessDay"]